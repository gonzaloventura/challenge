...
export default async function MachinesPage({ searchParams }) {
    ...
    return (
        <div className="flex flex-col gap-10 p-10">
            <h1 className="text-2xl font-semibold">{search.length == (null || undefined) ? 'No se encontraron resultados con "' + params.q + '"' : (search.length === 1 ? 'Se encontró 1 resultado con "' + params.q + '"' : "Se encontraron " + search.length + ' resultados con "' + params.q + '"')}</h1>
            <main>
